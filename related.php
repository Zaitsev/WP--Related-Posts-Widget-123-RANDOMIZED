<?php
/*
Plugin Name: Related Posts Widget 123 withThumbnails RANDOMIZED
Description: This is FORK of Related Posts Widget 123 withThumbnails plugin! (https://wordpress.org/plugins/advanced-css3-related-posts-widget)  You must NOT use them both  simultaneously!!! Added random posts if qury by tags will not retun required number of posts
...
//echo 'sssssssssssssssssssssssssssssssss' . $taglist;
...
function RelatedPostWidgetnull()
 {}
  function RelatedPostWidget()
  {
    ...
    $this->WP_Widget('RelatedPostsWidget', 'Related Posts With Thumbnail widget', $widget_ops);
  }
...
function rpw_add_options() {
	...
	add_options_page('Related Posts widget Options Page', 'Related Posts widget', 8, 'RelatedPostswidgetoptions', 'rpw_options_page');
