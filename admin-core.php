...

{
	...
	if($default_thumb == ''){$default_thumb = $rpwpluginsurl.'/images/noimage.png';}
...
<div class="simpleTabsContent" style="height: 467px; border: 1px solid #E9E9E9; padding: 4px" id="layer1">
	...
	view.</b></font></td>
			...
			<tr>
				...
				<td title="Best Value: 85px" width="64"><?php echo "<img title='Best Value: 85px' src='$rpwpluginsurl/images/what.gif' align='center' />";?></td>
...
<div class="simpleTabsContent" style="border: 1px solid #E9E9E9; padding: 4px">
	<h3>Description:</h3>
	<p>
	<h2>This is FORK of <a href="https://wordpress.org/plugins/advanced-css3-related-posts-widget/">Related Posts Widget 123 withThumbnails</a> plugin!</h2>
	<p><font color="red">You must NOT use then simultaneously!!!</font></p>
	<p>Added random posts if qury by tags will not retun required number of posts</p>
	</p>
	</div>
<!-- /new tab -->
